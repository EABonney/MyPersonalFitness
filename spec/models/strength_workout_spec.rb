...
describe StrengthWorkout do
  before do
    @swim = StrengthWorkout.new( :user_id => 1, :workout_date => "2010-01-01", :time_of_day => "00:00:00",
                             :duration => "00:30:00", :plan_type => "a")
  end
  ...
  it "should have a type of SwimWorkout" do
    @swim.type.should == "StrengthWorkout"
  end
